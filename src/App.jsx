...
const App = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const text = `Cześć Irek! Nazywam się ${formData.name}.

Prośba o pomoc: ${formData.message}

Mój numer telefonu: ${formData.phone}`;
        ...
        <div className="container">
          ...
          <motion.div {...fadeInUp} className="reviews-panel">
            <div className="reviews-stars" aria-hidden="true">
              {[...Array(5)].map((_, i) => <Star key={i} size={26} fill="#FFC107" color="#FFC107" />)}
            </div>
            <p>
              Opinie o mojej pracy zbieram w Google — tam nikt ich nie podkoloryzuje.
              Skorzystałeś z moich usług? Podziel się wrażeniami i pomóż sąsiadom znaleźć fachowca.
            </p>
            <a href="https://share.google/dLp2Yzpm0KwX41JQ0" target="_blank" rel="noopener noreferrer" className="google-reviews-link">
              <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.27-4.74 3.27-8.1z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.1c-.22-.66-.35-1.36-.35-2.1s.13-1.44.35-2.1V7.06H2.18A10.96 10.96 0 0 0 1 12c0 1.78.43 3.45 1.18 4.94l3.66-2.84z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.52 6.16-4.52z"/></svg>
              Zobacz i dodaj opinię w Google
            </a>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container contact-grid">
          <motion.div {...fadeInUp} className="contact-info">
            ...
            <div className="contact-methods">
              ...
              <a href="https://wa.me/48603721050" target="_blank" rel="noopener noreferrer" className="method whatsapp-link">
                <div className="method-icon"><WhatsAppIcon /></div>
                <div className="method-text">
                  <label>Napisz na WhatsApp</label>
                  <span>+48 603 721 050</span>
                </div>
              </a>
